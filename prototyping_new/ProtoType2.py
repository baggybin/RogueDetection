import sys
# multipleproccessing support
from multiprocessing import Process
# Scapy packet manipulation and construiction library
from scapy.all import *
# OS level access methods, simpler version than subprocesss
import os
#multiple threading support
from threading import Thread
import threading
#excetute terminal commands in linux
...
import manuf
import math
# wifi module to access linux terminal based wireless tools from python seemlesly 
...
# Decimal to handle larger floating point nunbers used by clock skew calculations
from decimal import *
        ...
        def PacketHandler(frame):
          ...
          try:    
            ...
            #Test if the frame is IEEE 802.11 and a beacon management frame and the correct SSID value
              ...
              # attempting to use self.channel which is current channel being scannned to stop
